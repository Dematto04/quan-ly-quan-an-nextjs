...
export default function EditEmployee({
  ...
  useEffect(() => {
    if (data) {
      ...
      console.log({hehe: form.getValues("changePassword"), haha:  form.getValues("password")});
      ...
      form.reset({
        ...
        confirmPassword: form.getValues("confirmPassword") || undefined,
      });
    }
  }, [data, form]);
  ...
  const onSubmit = async (values: UpdateEmployeeAccountBodyType) => {
    ...
    try {
      ...
      if (file) {
        ...
        const uploadImgResult = await uploadMediaMutation.mutateAsync(formData);
        const imageUrl = uploadImgResult.payload.data;
        body = {
          ...body,
          avatar: imageUrl,
        };
